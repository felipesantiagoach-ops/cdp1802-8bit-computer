...
CSEND1: ; SEX R2
        ...
        ; SHL                 ; GET THRE FLAG
        ; BNF CSEND1          ; borrado por atilio 6/12/22
        SEX R9
        INC R9
        ; OUT 2               ; borrado por atilio 6/12/22
        ;----------inicio rutina de transmision--------
        ;esta rutina solo termina cuando finaliza la transmision completa de un caracter
CONTB	EQU R4
DATO	EQU R5
CONTD 	EQU R6
...
DEL4
        ...
        ;----------fin rutina de transimison--------
        ; DEC R9 ; se borró uno de estos, porque no se ejecutó OUT 2 (OUT 2 aumenta R(X))
        DEC R9
        DEC R9
        DEC R9
        SEP RC
...
DEL11
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL11   	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
;-------------------------aquí termina el bit de inicio-------------------------------
;-----------------aquí comienza a transmitirse los bits de datos----------------------
		LDI 08D			; cargo el contador de bits a enviar 
		PLO CONTB
...
DEL21
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL21   	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
;-------------------------fin de transmisión de un bit-----------------------------------------
		DEC CONTB		; decremento el contador de bits enviados
		GLO CONTB		; cargo valor en D
		BNZ TDAT1		; continuo con el siguiente bit si todavía no llegó a cero
;-------------------------bit de parada---------------------------------------------
		SEQ				; Q=1
; bit time delay
		LDI  BITDLY		; carga el valor inmediato en D		2-Byte	2-Machine Cycles	1 time
...
DEL31
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL31   	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
; bit time delay
		LDI  BITDLY		; carga el valor inmediato en D		2-Byte	2-Machine Cycles	1 time
		PLO  CONTD		; carga el valor de D en R1.0		1-Byte	2-Machine Cycles	1 time
		LDI	00H
...
DEL41
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL41  	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
        ;----------fin rutina de transimison--------
        ; DEC RSTACK ; se comentó esta instrucción, porque no se ejecutó OUT 2 (OUT 2 aumenta R(X))
CR2:    ; INP 3
        ; SHL
        ; BNF CR2
        LDI $0A
...
DEL12
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL12   	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
;-------------------------aquí termina el bit de inicio-------------------------------
;-----------------aquí comienza a transmitirse los bits de datos----------------------
		LDI 08D			; cargo el contador de bits a enviar 
		PLO CONTB
...
DEL22
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL22   	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
;-------------------------fin de transmisión de un bit-----------------------------------------
		DEC CONTB		; decremento el contador de bits enviados
		GLO CONTB		; cargo valor en D
		BNZ TDAT2		; continuo con el siguiente bit si todavía no llegó a cero
;-------------------------bit de parada---------------------------------------------
		SEQ				; Q=1
; bit time delay
		LDI  BITDLY		; carga el valor inmediato en D		2-Byte	2-Machine Cycles	1 time
...
DEL32
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL32   	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
; bit time delay
		LDI  BITDLY		; carga el valor inmediato en D		2-Byte	2-Machine Cycles	1 time
		PLO  CONTD		; carga el valor de D en R1.0		1-Byte	2-Machine Cycles	1 time
		LDI	00H
...
DEL42
		DEC  CONTD     	; decrementa R1						1-Byte	2-Machine Cycles	R1 times
		GLO  CONTD     	; carga la parte alta de R1.0 en D	1-Byte	2-Machine Cycles	R1 times
		BNZ  DEL42  	; salta si D != 0					2-Byte	2-Machine Cycles	R1 times
        ;----------fin rutina de transimison--------
        ; DEC RSTACK ; se comentó esta instrucción, porque no se ejecutó OUT 2 (OUT 2 aumenta R(X))
        SEX R9
        SEP RC
...
LEND:   NOP                 ; INITIAL FENCE IS HERE
        ...
        ;
        ;
        ; rutina de transmisión serial por pin Q
        ;
        END
